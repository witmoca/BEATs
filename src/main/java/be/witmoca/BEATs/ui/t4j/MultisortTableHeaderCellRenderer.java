...
/**
 * An extension of <code>DefaultTableHeaderCellRenderer</code> that paints sort
 * icons on the header of each sorted column with varying opacity.
 * 
 * @author Darryl
 */
public class MultisortTableHeaderCellRenderer extends DefaultTableHeaderCellRenderer {
	...
	/**
	 * Constructs a <code>MultisortTableHeaderCellRenderer</code> with a default
	 * alpha of 0.5.
	 */
	...
	/**
	 * Constructs a <code>MultisortTableHeaderCellRenderer</code> with the specified
	 * alpha. A lower value represents greater contrast between icons, while a
	 * higher value can make more sort icons visible.
	 * 
	 * @param alpha
	 ...
	 * column is unsorted. The icon for the primary sorted column is fully opaque,
	 * and the opacity is reduced by a factor of <code>alpha</code> for each
	 * subsequent sort index.
	 *
	 * @param table
