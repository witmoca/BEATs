...
/**
 * YearMonthSpinner is a composite of two spinners, one for the month and the
 * other for the year, used to select a java.time.MonthYear.
 * <P>
...
public class YearMonthSpinner extends JPanel {
	...
	private SpinnerTemporalModel monthModel;
	private SpinnerTemporalModel yearModel;
	private JSpinner monthSpinner;
	private JSpinner yearSpinner;

	/**
	 * Constructs a YearMonthSpinner with the current year and month, with no lower
	 * or upper limits.
	 *
	 */
	...
	/**
	 * Constructs a YearMonthSpinner with the supplied year and month, with no lower
	 * or upper limits.
	 *
	 * @param value
	 *            the initial value
	...
	/**
	 * Constructs a YearMonthSpinner with the supplied year and month, lower
	...
	public YearMonthSpinner(YearMonth value, YearMonth min, YearMonth max) {
		...
		SpinnerTemporalEditor yearEditor = new SpinnerTemporalEditor(yearSpinner, DateTimeFormatter.ofPattern("uuuu"));
	...
	/**
	 * Returns the minimum value (earliest year/month), or <CODE>null</CODE> if no
	 * limit is set.
	 *
	...
	/**
	 * Sets the minimum value (earliest year/month). Call this method with a
	 ...
	 *
	 * @param min
	 *            The earliest year/month that can be selected, or <CODE>null</CODE>
	 *            for no limit.
	 */
	public void setMin(YearMonth min) {
		monthModel.setTemporalMin(min);
		yearModel.setTemporalMin(min);
	}

	/**
	 * Returns the maximum value (latest year/month), or <CODE>null</CODE> if no
	 * limit is set.
	 *
	...
	/**
	 * Sets the maximum value (latest year/month). Call this method with a
	 * <CODE>null</CODE> value for no limit.
	 * <P>
	 * This class does not attempt to verify that min <= value <= max. It is the
	 * responsibility of client code to supply a sane value.
	 *
	 * @param max
	 *            The latest year/month that can be selected, or <CODE>null</CODE>
	 *            for no limit.
	 */
	public void setMax(YearMonth max) {
		monthModel.setTemporalMax(max);
		yearModel.setTemporalMax(max);
	}
}
