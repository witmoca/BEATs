...
class SpinnerTemporalModel extends AbstractSpinnerModel {
	 ...
	 * @param min
	 *            the earliest element in the sequence, or null for no limit.
	 * @param max
	 *            the latest element in the sequence, or null for no limit.
	 * @param step
	 *            the temporal period between elements of the sequence
	 *
	 * @throws IllegalArgumentException
	 *             if value is null or either or both of min/max are non-null and
	 *             (minimum <= value <= maximum) is false. @throws
	 ...
	 * @return
	 */
	public YearMonth getTemporalValue() {
		return value;
	}
	 ...
	 *            The value to set
	 * @throws IllegalArgumentException
	 *             if value is null or cannot be cast to the requisite type.
	 *
	 */
	@Override
	...
	public Object getNextValue() {
		...
		YearMonth newValue = step.addTo(value, 1);
	 ...
	 *            the earliest value
	 */
	public void setTemporalMin(YearMonth min) {
	 ...
	 *             if the step is not supported by the temporal type e.g. attempting
	 *             to set ChronoUnit.DAYS when the type T is YearMonth.
	 */
