...
public class LiveViewTableModel extends AbstractTableModel implements DataChangedListener {
	...
	LiveViewTableModel(String playlistName, LiveViewDataClient lvdc) {
		super();
